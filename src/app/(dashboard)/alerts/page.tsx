...
const alerts: { id: string; title: string; source: string; time: string; severity: Sev }[] = [
  { id: "1", title: "Power Meter Offline", source: "MTR-PWR-04 · Gedung B", time: "11:12", severity: "critical" },
  { id: "2", title: "High Water Level", source: "Flood · Titik D (Bahaya)", time: "11:05", severity: "critical" },
  { id: "3", title: "Penyusupan Area Vital", source: "CCTV · People Surveillance", time: "11:01", severity: "critical" },
  { id: "4", title: "Water Meter Offline", source: "Water · Cikondang", time: "10:58", severity: "warning" },
  { id: "5", title: "Overspeed Detected", source: "Fleet · Toyota Hilux (B 5432 LPT)", time: "10:47", severity: "warning" },
  { id: "6", title: "Server Room Temp High", source: "TempHum · 29.4°C", time: "10:33", severity: "warning" },
  { id: "7", title: "Camera Offline", source: "CCTV · 04. Koridor Lt.1", time: "10:20", severity: "info" },
  { id: "8", title: "Batasan Area Dilanggar", source: "CCTV · People Surveillance", time: "10:15", severity: "warning" },
  { id: "9", title: "Pintu Terbuka Terlalu Lama", source: "CCTV · Ruang Kontrol", time: "10:05", severity: "info" },
  { id: "10", title: "Overcurrent Detected", source: "MTR-PWR-02 · Gardu 3", time: "09:55", severity: "warning" },
];
...
const summary = [
  { key: "all", label: "Total Lansiran", value: alerts.length, cls: "bg-white/45 border-white/70", text: "text-slate-800" },
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`text-[9px] font-extrabold px-1.5 py-0.5 rounded-full border flex-shrink-0 ${m.chip}`}>{m.label}</span>
                    </div>
                    <span className="text-[10px] font-semibold text-slate-400 block mt-0.5 truncate">{a.source}</span>
                  </div>
                </div>
                <div className="flex items-center gap-3 flex-shrink-0">
                  <span className="text-[11px] font-mono font-bold text-slate-500">{a.time} WIB</span>
                  <button className="flex items-center gap-1 text-[10px] font-bold text-slate-500 bg-white/80 border border-slate-200 rounded-lg px-2.5 py-1.5 hover:bg-white hover:text-slate-800 transition cursor-pointer">
                    <CheckCheck className="h-3 w-3" /> Tandai
                  </button>
                  <button className="flex items-center gap-1 text-[10px] font-bold text-white bg-brand-red rounded-lg px-2.5 py-1.5 hover:bg-brand-red-hover transition cursor-pointer">
