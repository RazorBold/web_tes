...
export default function CctvHeatmapLightbox({ frame, index, total, onClose, onPrev, onNext }: Props) {
  ...
  return createPortal(
    ...
    >
      <div className="relative w-full max-w-[1100px] max-h-[92vh] flex flex-col bg-slate-900 border border-slate-700/70 rounded-3xl overflow-hidden shadow-2xl animate-pop-in">
